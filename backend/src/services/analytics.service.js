  ...
  const auditLogs = [
    {
      ...
      target: 'Produce Pass SIR-20260902-005 (Wheat 35.0 Qtl)',
    ...
    },
    {
      ...
      target: 'Fatehabad APMC Daily Limit +10 Slots',
    ...
    },
    {
      ...
      target: 'Farmer Ramesh Kumar · Gate 1 Out',
    ...
    },
    {
      ...
      actor: 'State Director of Agriculture',
      role: 'state_admin',
      action: 'Admin Login',
      target: 'Directorate Governance Session Established',
  ...
  const complaints = [
    {
      ...
      phone: '9876500005',
      district: 'Kaithal',
      mandi: 'Kaithal Mandi Procurement Centre',
    ...
    },
    {
      ...
      phone: '9876500008',
      district: 'Fatehabad',
      mandi: 'Fatehabad APMC Mandi',
      category: 'Slot Timing Adjustment',
      description: 'Tractor breakdown on NH-9; requested 1-hour entry grace window.',
      status: 'Resolved',
    ...
    },
    {
      ...
      phone: '9876500020',
      district: 'Sirsa',
      mandi: 'Sirsa Grain Procurement Centre',
